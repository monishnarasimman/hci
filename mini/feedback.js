function rate(stars) {
    ...
    localStorage.setItem('userRating', stars); // Save rating to local storage
}
...
function startDictation() {
    if (window.hasOwnProperty('webkitSpeechRecognition')) {
        ...
        recognition.onresult = function(e) {
            ...
            localStorage.setItem('userComment', e.results[0][0].transcript); // Save comment to local storage
            recognition.stop();
        };
